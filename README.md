...
**Le tirage des petits papiers, en ligne.** Ajoutez vos participants, posez vos
règles, lancez le tirage. Aucune donnée ne quitte votre navigateur.
...
Vous connaissez le rituel : on écrit les prénoms sur des bouts de papier, on
plie, on secoue le chapeau, et quelqu'un finit toujours par se tirer lui-même.
On recommence. Puis on se souvient que Léa et Tom sont en couple, qu'ils
s'offrent déjà un cadeau, et qu'il vaudrait mieux éviter. On recommence encore.
...
## Les résultats restent secrets

C'est le point délicat de tout tirage organisé par quelqu'un : celui qui appuie
sur le bouton ne devrait pas tout voir.

Les résultats s'affichent **masqués par défaut**. Vous révélez une ligne à la
fois, uniquement si vous en avez besoin. Et pour chaque participant, un bouton
copie un message déjà rédigé — nom du destinataire inclus — que vous n'avez plus
...
- 🌙 **Thème clair et sombre**, calé par défaut sur les préférences de votre
  système.
- 📱 **Du téléphone au grand écran**, sans application à installer.
- 🔍 Une **recherche** dans la liste, et des participants **regroupés par
  groupe** avec un code couleur, pour s'y retrouver quand la tablée s'agrandit.
- ♿ Navigation au clavier et libellés pensés pour les lecteurs d'écran.
...
Aucune limite fixée, et le calcul reste quasi instantané même pour une grande
tablée.

**Ça marche pour autre chose qu'un Secret Santa ?**
Oui. Rien n'est spécifique à Noël : répartition de tâches, binômes de relecture,
attribution de sujets, « qui apporte quoi » — tout ce qui se tire au sort avec
des règles.

**Et si le tirage est impossible ?**
Si l'application ne trouve aucune combinaison satisfaisant toutes vos règles,
elle vous l'annonce clairement plutôt que de bricoler un résultat. C'est en
général le signe qu'une exclusion est de trop : retirez-en une et relancez.

---

<sub>Les Petits Papiers est une application web ouverte, construite avec React,
TypeScript et Tailwind CSS. Elle fonctionne entièrement dans le navigateur.</sub>
